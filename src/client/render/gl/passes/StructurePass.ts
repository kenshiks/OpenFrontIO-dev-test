 ...
 * sampled from a pre-built 8-column sprite atlas (columns 0-5 from
 * generate-sprite-atlases.mjs, columns 6-7 — Airport, Air Defence —
 * hand-appended from the existing build-menu SVGs).
 *
